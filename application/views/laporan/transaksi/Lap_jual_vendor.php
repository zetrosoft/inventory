...
if($all_penjualanperpelanggan!=''){
	...
	addText(array('Nama Pelanggan','>300'),
            array('',"<input type='text' id='ID_Anggota' name='ID_Anggota' data-provide='typeahead' width='300px' value='' class='cari w100'/>"),true,'',"width='300px'");
	addText(array('Periode :'.nbs(1),' s/d ',''),array(
...
$(document).ready(function(e) {
    ...
    $('#frm1 input#ID_Anggota').attr({'data-source':'[<?=$nasabah;?>]'});
});
</script>