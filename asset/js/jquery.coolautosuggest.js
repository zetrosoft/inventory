	...
	function autosuggest(callBackUrl, textField){
		...
		this.textField.keyup(
			function(e){
				if(e.keyCode!=37 && e.keyCode!=38 && e.keyCode!=39 && e.keyCode!=40 && e.keyCode!=13){
				 // if(FirstChars!=null || $(this).val().charAt(0)==FirstChars){
		...
		this.show=function(height){
			...
			this.holder.css({
				...
				"top"		:(ck < 464)? (this.textField.position().top-(48*this.arrData.length)):this.textField.position().top + this.textField.height() + 5 + "px"
				//"height"	:height + "px"
			});
